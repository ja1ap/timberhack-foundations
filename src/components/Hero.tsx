    ...
    <div className="relative container mx-auto pb-20 md:pb-28 pt-32">
      <div className="max-w-4xl animate-fade-up">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <a
            href="#contato"
            className="group inline-flex items-center gap-2 px-7 py-4 rounded-full bg-primary text-primary-foreground font-semibold hover:bg-primary-glow transition-all shadow-brand hover:scale-[1.02] ease-expo"
          >
            Fale com a gente
          ...
          <a
            href="#portfolio"
            className="inline-flex items-center gap-2 px-7 py-4 rounded-full border border-white/20 text-white font-semibold hover:bg-white/10 backdrop-blur-md transition-colors"
          >
            Ver projetos
          </a>
        </div>
      ...
      <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-px bg-white/10 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-md">
        {[
